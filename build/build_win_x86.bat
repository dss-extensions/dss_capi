...
if not exist lib\win_x86 ( mkdir lib\win_x86 )
...
rd /s /q build\units_x86_dbg
mkdir .\build\units_x86_dbg
...
if exist lib\win_x86\altdss_capid.dll (
    ...
    echo LIBRARY ALTDSS_CAPID > lib\win_x86\altdss_capid.def
...
IF DEFINED CI (
    ...
    msbuild src\COM\COM_DSSExtensions.vcxproj /p:Configuration=Release /p:Platform=Win32 /p:OutputPath=%cd%\lib\win_x86 /p:RegisterOutput=false
