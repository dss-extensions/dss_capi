...
begin
    ...
    begin
        ...
        DataStr := AuxParser[ActiveActor].StrValue;
        if Length(DataStr) > 0 then
            pCommHide^[(iNodeNum - 1) * Nodes + i - 1] := AuxParser[ActiveActor].intValue;
    end;
...
begin
    ...
    begin
        ...
        DataStr := AuxParser[ActiveActor].StrValue;
        if Length(DataStr) > 0 then
            pCommNode_Hide^[(iNodeNum - 1) * Nodes + i - 1] := AuxParser[ActiveActor].intValue;
    end;
    ...
    case phase_num of //pos seq
        ...
        begin
          //1.calculate d_ij*alpha_j summation
            ...
            if (NodeNumofDG = atk_node_num) and (atk = TRUE) and (ActiveCircuit[ActorID].Solution.DynaVars.t >= atk_time) then
            begin
...
begin
    ...
    if (atk = TRUE) and (ActiveCircuit[ActorID].Solution.DynaVars.SolutionMode = DYNAMICMODE) and (ActiveCircuit[ActorID].Solution.DynaVars.t >= atk_time) then
    begin
