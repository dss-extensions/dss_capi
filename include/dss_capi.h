...
extern "C" {
    ...
    */
    ...
    DSS_CAPI_DLL void Obj_GetFloat64Array(void *obj, int32_t Index, double** ResultPtr, int32_t* ResultCount);
    DSS_CAPI_DLL void Obj_GetInt32Array(void *obj, int32_t Index, int32_t** ResultPtr, int32_t* ResultCount);
    DSS_CAPI_DLL void Obj_GetStringArray(void *obj, int32_t Index, char*** ResultPtr, int32_t* ResultCount);
    DSS_CAPI_DLL void Obj_GetObjectArray(void *obj, int32_t Index, void** ResultPtr, int32_t* ResultCount);
