...
extern "C" {
    ...
    */
    ...
    DSS_CAPI_V8_DLL int32_t CNData_Get_Count();
    DSS_CAPI_V8_DLL int32_t CNData_Get_First();
    DSS_CAPI_V8_DLL int32_t CNData_Get_Next();
    DSS_CAPI_V8_DLL char *CNData_Get_Name();
    ...
    DSS_CAPI_V8_DLL int32_t LineSpacings_Get_Count();
    DSS_CAPI_V8_DLL int32_t LineSpacings_Get_First();
    DSS_CAPI_V8_DLL int32_t LineSpacings_Get_Next();
    DSS_CAPI_V8_DLL char* LineSpacings_Get_Name();
    DSS_CAPI_V8_DLL void LineSpacings_Set_Name(char* Value);
    DSS_CAPI_V8_DLL int32_t LineSpacings_Get_Nconds();
    DSS_CAPI_V8_DLL void LineSpacings_Set_Nconds(int32_t Value);
    DSS_CAPI_V8_DLL int32_t LineSpacings_Get_Phases();
    DSS_CAPI_V8_DLL void LineSpacings_Set_Phases(int32_t Value);
    DSS_CAPI_V8_DLL int32_t LineSpacings_Get_Units();
    ...
    DSS_CAPI_V8_DLL void LineSpacings_Get_Xcoords_GR();
    ...
    DSS_CAPI_V8_DLL void LineSpacings_Get_Ycoords_GR();
    ...
    DSS_CAPI_V8_DLL void Reactors_Get_AllNames_GR();
    DSS_CAPI_V8_DLL char* Reactors_Get_Name();
    DSS_CAPI_V8_DLL void Reactors_Set_Name(char *Value);
    DSS_CAPI_V8_DLL int32_t Reactors_Get_First();
    DSS_CAPI_V8_DLL int32_t Reactors_Get_Next();
    DSS_CAPI_V8_DLL int32_t Reactors_Get_Count();
    DSS_CAPI_V8_DLL double Reactors_Get_kV();
    DSS_CAPI_V8_DLL void Reactors_Set_kV(double Value);
    DSS_CAPI_V8_DLL double Reactors_Get_kvar();
    DSS_CAPI_V8_DLL void Reactors_Set_kvar(double Value);
    DSS_CAPI_V8_DLL int32_t Reactors_Get_Phases();
    DSS_CAPI_V8_DLL void Reactors_Set_Phases(int32_t Integer);
    DSS_CAPI_V8_DLL uint16_t Reactors_Get_IsDelta();
    DSS_CAPI_V8_DLL void Reactors_Set_IsDelta(uint16_t Value);
    DSS_CAPI_V8_DLL uint16_t Reactors_Get_Parallel();
    DSS_CAPI_V8_DLL void Reactors_Set_Parallel(uint16_t Value);
    DSS_CAPI_V8_DLL double Reactors_Get_LmH();
    DSS_CAPI_V8_DLL void Reactors_Set_LmH(double Value);
    DSS_CAPI_V8_DLL char* Reactors_Get_Bus1();
    DSS_CAPI_V8_DLL char* Reactors_Get_Bus2();
    DSS_CAPI_V8_DLL void Reactors_Set_Bus1(char* Value);
    DSS_CAPI_V8_DLL void Reactors_Set_Bus2(char* Value);
    DSS_CAPI_V8_DLL double Reactors_Get_R();
    DSS_CAPI_V8_DLL void Reactors_Set_R(double Value);
    DSS_CAPI_V8_DLL double Reactors_Get_X();
    DSS_CAPI_V8_DLL void Reactors_Set_X(double Value);
    DSS_CAPI_V8_DLL double Reactors_Get_Rp();
    DSS_CAPI_V8_DLL void Reactors_Set_Rp(double Value);
    DSS_CAPI_V8_DLL char* Reactors_Get_RCurve();
    DSS_CAPI_V8_DLL void Reactors_Set_RCurve(char* Value);
    DSS_CAPI_V8_DLL char* Reactors_Get_LCurve();
    ...
    DSS_CAPI_V8_DLL void Reactors_Get_Rmatrix_GR();
    ...
    DSS_CAPI_V8_DLL void Reactors_Get_Xmatrix_GR();
    ...
    DSS_CAPI_V8_DLL void Reactors_Get_Z_GR();
    ...
    DSS_CAPI_V8_DLL void Reactors_Get_Z1_GR();
    ...
    DSS_CAPI_V8_DLL void Reactors_Get_Z2_GR();
    ...
    DSS_CAPI_V8_DLL void Reactors_Get_Z0_GR();
    DSS_CAPI_V8_DLL void Reactors_Set_Z0(double* ValuePtr, int32_t ValueCount);
    
    DSS_CAPI_V8_DLL int32_t TSData_Get_Count();
    DSS_CAPI_V8_DLL int32_t TSData_Get_First();
    DSS_CAPI_V8_DLL int32_t TSData_Get_Next();
    DSS_CAPI_V8_DLL char *TSData_Get_Name();
