     ...
     Begin
         ...
         Begin
             ...
             CASE iCASE OF
               ...
               propUSERDATA     : If UserModel.Exists then UserModel.Edit := Parser.StrValue;  // Send edit string to user model
               ...
               propDynaData     : If DynaModel.Exists then DynaModel.Edit := Parser.StrValue;
