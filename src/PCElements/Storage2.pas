...
begin
  ...
  // continue parsing with contents of Parser
    ...
    ActiveCircuit.ActiveCktElement := ActiveStorage2Obj;
...
//----------------------------------------------------------------------------
function TStorage2.Init(Handle: Integer): Integer;
var
    p: TStorage2Obj;
...
// - - - - - - - - - - - - - - - - - - - - - - - -- - - - - - - - - - - - - - - - - -
procedure TStorage2Obj.GetInjCurrents(Curr: pComplexArray);
