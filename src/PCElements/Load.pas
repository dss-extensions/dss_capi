...
begin
    ...
    case Idx of
        ...
        begin
            ...
            if (DSS_EXTENSIONS_COMPAT and ord(DSSCompatFlag.NoPropertyTracking)) = 0 then
            begin
                if PrpSequence[ord(TProp.kW)] = 0 then
                    SetAsNextSeq(ord(TProp.kW));
                // SetAsNextSeq(ord(TProp.kvar));
                PrpSequence[ord(TProp.kVA)] := 0;
...
begin
    ...
    begin
        CVRFactor := CVRShapeObj.MultAtHour(Hr);    // Complex
...
begin
    ...
    begin
        ...
        begin
            ...
            calcYear := ActiveCircuit.Solution.DynaVars.dblHour / 8760; // Aprox year
            if (calcYear < 1) then
            begin
                if (firstY = 0) then
