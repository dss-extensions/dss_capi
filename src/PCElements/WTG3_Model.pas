...
procedure TGE_WTG3_Model.abc2seq(var abc: TPhArray; var seq: TSymCompArray; ang: Double);
var
    ii: Integer;
    temp: Complex;
begin
...
procedure TGE_WTG3_Model.seq2abc(var abc: TPhArray; var seq: TSymCompArray; ang: Double);
var
    ii: Integer;
    temp: Complex;
begin
...
function TGE_WTG3_Model.CalcPmech(theta: Double; wrotor: Double; spdwind: Double): Double;
var
    lmbda, Cp: Double;
begin
