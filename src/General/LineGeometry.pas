...
begin
    ...
    PropertyFlags[ord(TProp.wire)] := [TPropertyFlag.Transform_LowerCase];
    PropertyFlags[ord(TProp.cncable)] := [TPropertyFlag.Transform_LowerCase];
    PropertyFlags[ord(TProp.tscable)] := [TPropertyFlag.Transform_LowerCase];
