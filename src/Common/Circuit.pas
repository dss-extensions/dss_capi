...
begin
    Result := FALSE;
    try
        F := TBufferedFileStream.Create(DSS.OutputDirectory {DSS.CurrentDSSDir} + 'BusVoltageBases.dss', fmCreate);
...
begin
    Result := FALSE;
    try
        F := TBufferedFileStream.Create(DSS.OutputDirectory {DSS.CurrentDSSDir} + 'Master.dss', fmCreate);
        FSWriteln(F, 'Clear');
...
begin
    ...
    try
        F := TBufferedFileStream.Create(DSS.OutputDirectory {DSS.CurrentDSSDir} + 'BusCoords.dss', fmCreate);
