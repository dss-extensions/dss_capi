    ...
    try
        ...
        begin
            ...
            begin
                ...
                FSWriteln(F);
                WriteStr(sout, Pad('Bus', MaxBusNameLength), 'Node', Pad(' ', 12), 'Amps', Pad(' ', 3), 'X/R ', 'Node', Pad(' ', 12), 'Amps', Pad(' ', 3), 'X/R ', 'Node', Pad(' ', 12), 'Amps', Pad(' ', 3), 'X/R ...');
                FSWriteln(F, sout);
                FSWriteln(F);
                for iBus := 1 to NumBuses do
                    ...
                    begin
                        ...
                        begin
                            ...
                            WriteStr(sout, GetNum(i));
                            FSWrite(F, sout);
                            WriteStr(sout, CurrMag: 15: 0);
                            FSWrite(F, sout);
