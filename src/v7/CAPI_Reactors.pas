...
begin
  e := nil;
  if ActiveCircuit <> Nil then e := ActiveCircuit.Reactors.Active;
  Result := e;
end;
//------------------------------------------------------------------------------
  ...
  begin
    ...
    CASE prop OF
       ...
       ReactorProps.Z:  Begin
               ...
               SpecType := 2;
            End;
       ReactorProps.RCurve: RCurveObj   := XYCurveClass.Find(RCurve);
       ReactorProps.LCurve: LCurveObj   := XYCurveClass.Find(LCurve);
    ...
    CASE prop OF
        ReactorProps.phases..ReactorProps.Z: YprimInvalid := True;
        ...
        ReactorProps.LmH: YprimInvalid := True;
    ELSE
    END;
  end;
end;
