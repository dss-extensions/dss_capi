...
begin
    ...
    try
        FBranches := TBufferedFileStream.Create(DSS.OutputDirectory {DSS.CurrentDSSDir} + 'Branches.dss', fmCreate);     // Both lines and transformers
        NBranches := 0;
    except
        On E: Exception do
        begin
    ...
    try
        FXfmrs := TBufferedFileStream.Create(DSS.OutputDirectory {DSS.CurrentDSSDir} + 'Transformers.dss', fmCreate);     // Both lines and transformers
        NXfmrs := 0;
    except
        On E: Exception do
        begin
    ...
    try
        FShunts := TBufferedFileStream.Create(DSS.OutputDirectory {DSS.CurrentDSSDir} + 'Shunts.dss', fmCreate);
        NShunts := 0;
    except
        On E: Exception do
        begin
    ...
    try
        FLoads := TBufferedFileStream.Create(DSS.OutputDirectory {DSS.CurrentDSSDir} + 'Loads.dss', fmCreate);
        Nloads := 0;
    except
        On E: Exception do
        begin
    ...
    try
        FGens := TBufferedFileStream.Create(DSS.OutputDirectory {DSS.CurrentDSSDir} + 'Generators.dss', fmCreate);
        NGens := 0;
    except
        On E: Exception do
        begin
    ...
    try
        FCaps := TBufferedFileStream.Create(DSS.OutputDirectory {DSS.CurrentDSSDir} + 'Capacitors.dss', fmCreate);
        Ncaps := 0;
    except
        On E: Exception do
        begin
