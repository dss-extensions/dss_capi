...
{ Return zero length Array if no circuit or no Y matrix}
   IF ActiveCircuit = nil                Then Result := DSS_CreateArray_PDouble(ResultPtr, ResultCount, (0) + 1)
   ELSE If ActiveCircuit.Solution.hY = 0 Then Result := DSS_CreateArray_PDouble(ResultPtr, ResultCount, (0) + 1)
   ELSE
   With ActiveCircuit Do Begin
