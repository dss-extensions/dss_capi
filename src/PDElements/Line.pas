...
{$SCOPEDENUMS OFF}
    ...
    PUBLIC
        ...
        FWireDataSize, FWireDataNPhases: Integer;
...
begin
    ...
    // list of objects
    PropertyStructArrayCountOffset := ptruint(@obj.FWireDataNPhases);
    ...
    PropertyFlags[ord(TProp.wires)] := [TPropertyFlag.WriteByFunction];
    ...
    PropertyScale[ord(TProp.C1)] := 1.0e-9; // Convert from nano to farads

    PropertyOffset[ord(TProp.C0)] := ptruint(@obj.C0);
    PropertyScale[ord(TProp.C0)] := 1.0e-9; // Convert from nano to farads
...
begin
    ...
    FWireDataNPhases := LineSpacingObj.NPhases;
end;
