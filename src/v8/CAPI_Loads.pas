...
begin
    ...
    // keep kvar nominal up to date WITH kW and PF
        case prop of
            ...
            LoadProps.growth:
                GrowthShapeObj := GrowthShapeClass[ActiveActor].Find(GrowthShape);
 ...
 {*** see set_kwh, etc           28..30: LoadSpecType := 4;  // kWh, days, cfactor, PF }
            LoadProps.CVRCurve:
                CVRShapeObj := LoadShapeClass[ActiveActor].Find(CVRshape);
        end;
    end;
end;
//------------------------------------------------------------------------------
...
begin
    ...
    if ActiveCircuit[ActiveActor] = NIL then
        Exit;
    Generic_Get_AllNames(ResultPtr, ResultCount, ActiveCircuit[ActiveActor].Loads, False);
end;
//------------------------------------------------------------------------------
function Loads_Get_First(): Integer; CDECL;
var
